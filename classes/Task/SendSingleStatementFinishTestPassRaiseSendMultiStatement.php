...
use ILIAS\{DI\Container,
    ...
    Plugin\XapiProgress\Statement\FinishTestPass,
    Plugin\XapiProgress\Statement\FinishTestResponse,
    Plugin\XapiProgress\Xapi\Request\XapiRequest,
    Plugin\XapiProgress\Xapi\Statement\XapiStatementBuilder,
    Plugin\XapiProgress\Xapi\Statement\XapiStatementList};
...
class SendSingleStatementFinishTestPassRaiseSendMultiStatement extends SendSingleStatement
{
    ...
    protected FinishTestPass $statementFinishTestPass;

    protected \ilLogger $logger;

    protected array $finishTestPassParam;

    protected array $finishTestResponseEntries;
    ...
    public function run(array $input, Observer $observer) : Value
    {
        ...
        $this->lrsType = \ilXapiProgressPlugin::getLrsType();
        ...
        if((array_flip(\ilXapiProgressPlugin::getSelectedEvents())['finishTestResponse'] ?? false)) {
    ...
    private function getFinishTestResponseEntries() : bool
    {
        ...
        try {
            ...
            $this->logger->info('########## XapiProgress | EXCEPTION $this->statementFinishTestPass = new FinishTestPass($this->lrsType, $this->finishTestPassParam, \'finishTestPass\');');
            ...
            if ($values['qid']) {
                ...
                try {
                    ...
                    try {
                        ...
                        $this->logger->info('########## XapiProgress | EXCEPTION $solutionsRaw = $questionUi->object->getSolutionValues($this->statementFinishTestPass->active_id, $this->statementFinishTestPass->pass);');
                    ...
                    $this->logger->info('########## XapiProgress | EXCEPTION $questionUi = $this->statementFinishTestPass->ilTestServiceGui->object->createQuestionGUI("", $values[\'qid\']);');
